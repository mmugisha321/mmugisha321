...
echo "<table><tr><th id=td>ID</td> <th id=td>First Name</td> <th id=td>Last Name</td> <th id=td>Age</td> <th id=td>Address</td> <th id=td>Gender</th> <th id=td>Salary</th> <th id=td>Service Time</th><th id=td>Update</th>";
...
echo "<td id=td><a href='edit3.php?id=".$query2['id']."'><img src=edit.png height=22 width=22></a></td></<tr>";
}
?>
