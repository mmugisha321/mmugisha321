...
<td width="550">
        ...
        <?php
include('config.php');
$query1=mysql_query("select bus_id, number_plate, passengers, cost, tank, manu, max from bus");
echo "<table><tr><th id=td>ID</td> <th id=td>Plate number</td> <th id=td>Passengers</td> <th id=td>Price</td> <th id=td>Tank</td> <th id=td>Manu</th> <th id=td>Maximum</th> <th id=td>Update</th>";
...
echo "<td id=td><a href='edit2.php?bus_id=".$query2['bus_id']."'><img src=edit.png height=22 width=22></a></td></<tr>";
}
?>
