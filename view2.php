...
<th width="144" id="idd">Address</th>
<th width="144" id="idd">Gender</th>
<th width="144" id="idd">Salary</th>
<th width="144" id="idd">Service Time</th>
</tr>
...
echo "<tr><td id=idd>". $row["id"]. "</td><td id=idd>". $row["fname"]. "</td><td id=idd>". $row["lname"]. "</td><td id=idd>". $row["age"]. "</td><td id=idd>". $row["address"]. "</td><td id=idd>". $row["gender"]. "</td><td id=idd>". $row["salary"]. "</td><td id=idd>". $row["worked_years"]."</td></tr>";
}
echo "</table>";
}
else
