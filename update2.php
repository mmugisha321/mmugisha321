...
echo "<table><tr><th id=td>ID</td> <th id=td>Clients Number</td> <th id=td>Update</th>";
...
echo "<td id=td><a href='edit4.php?id=".$query2['id']."'><img src=edit.png height=22 width=22></a></td></<tr>";
}
?>
