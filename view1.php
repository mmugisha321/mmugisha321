...
<th width="144" id="idd">Plate number</th>
<th width="144" id="idd">Passengers</th>
<th width="144" id="idd">Price</th>
<th width="144" id="idd">Tank</th>
<th width="144" id="idd">Manufacture</th>
<th width="144" id="idd">maximum</th>
</tr>
...
echo "<tr><td id=idd>". $row["bus_id"]. "</td><td id=idd>". $row["number_plate"]. "</td><td id=idd>". $row["passengers"]. "</td><td id=idd>". $row["cost"]. "</td><td id=idd>". $row["tank"]. "</td><td id=idd>". $row["manu"]. "</td><td id=idd>". $row["max"]. "</td></tr>";
}
echo "</table>";
}
else
